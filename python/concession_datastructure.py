...
print('\nThe popcorn cost $' + (popcornPrice) + ' and your beverage cost $' + (beveragePrice) + ' with a tax of $' + round(tax, 2) + '. Your final total including a $2.00 surcharge is, $' + round(popcornPrice + beveragePrice + tax + surcharge, 2) + '. Thanks for purchasing your grub here!') 
